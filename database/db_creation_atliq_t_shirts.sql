...
BEGIN
    ...
    WHILE counter < max_records DO
        ...
        BEGIN
            DECLARE CONTINUE HANDLER FOR SQLEXCEPTION BEGIN END;  -- Handle SQL exceptions
            INSERT IGNORE INTO t_shirts (brand, color, size, price, stock_quantity)
...
-- Ensure that the t_shirt_id values match existing IDs from the t_shirts table
